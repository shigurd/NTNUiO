...
class QuizApp(tk.Tk):
    def __init__(self, file_path_list):
        ...
        self.year_list = [f'{y}' for y in range(2023, 2015, -1)]
        self.category_list = ['Nasjonal', 'MFFAGPR', 'MD4062', 'MD4061', 'MD4043', 'MD4042', 'MD4030', 'MD4020', 'MD4011']
        self.order_mode = ['Kronologisk', 'Tilfeldig']
        self.hidden_mode = ['Standard MCQ', 'Skjult MCQ']
        self.filter_tags = []
        self.title('NTNUiO Medisinquiz')
    ...
    def create_menu_dock_container(self):
        ...
        white_space = tk.Label(self.start_container, text='NTNUiO Medisin',
                                                   font=self.configs_tk['font_i'], justify='left',
                                                   wraplength=self.configs_tk['w_length'])
    ...
    def create_tag_filter_container(self):
        ...
        info_text = tk.Label(self.tag_filter_container,
                             ...
                             wraplength=self.configs_tk['w_length'])
        info_text.pack(anchor='w')
        filter_explaination = tk.Label(self.tag_filter_container, text='Filtrerer oppgaver i utvalget basert på ønskede stikkord. Bruk "," mellom hvert stikkord. Filteret er case og space sensitivt (feks vil "slag" vs "slag " ikke være det samme, heller ikke "CT" vs "ct"). Tomt filter inkluderer alle oppgaver for utvalget.', font=self.configs_tk['font_i'], justify='left',
                             wraplength=self.configs_tk['w_length'])
